    ...
    <div className='px-[2rem] md:px-[4rem] lg:px-[8rem] font-abril my-12 '>
      <div className="flex flex-wrap">
        <div className="w-full md:w-8/12 lg:w-7/12 lg:pr-16 text-center md:text-left">
          <p className='text-6xl md:text-8xl font-abril '>Welcome <span className='text-2xl md:text-4xl'>to</span></p>
          <div className="flex justify-center md:justify-normal">
            <img src={nj2} alt="nj2" className='h-[3rem] md:h-[4.6rem] flex-none relative top-2 md:top-2.5'/>
            <p className='text-6xl md:text-8xl flex-initial ms-3  md:ms-4'>Official</p>
          </div>
          <div>
            <div className='bg-blue-900 text-blue-600 w-auto inline-block px-12 mt-4 rounded-full -rotate-[1.5deg] absolute translate-y-1'>
              <p className='text-6xl md:text-8xl inline relative bottom-1'>Fansite.</p>
            </div>
